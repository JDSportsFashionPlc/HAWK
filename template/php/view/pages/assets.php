...
<h2>Asset Management - Coming Soon</h2>
...
<div>
	...
	<div class="well">
		<div class="row">
			...
			<div class="col-md-6" style="text-align:right">
				<a href="" class="btn btn-xs btn-success">New File</a>
				<a href="" class="btn btn-xs btn-success">New Folder</a>
			</div>
	...
	<div class="table-responsive"> 
		...
		<div><div class="well"><div class="row"><div class="col-md-7">
